    ...
    <div class="absolute inset-x-0 bottom-0 flex justify-between py-2 pr-2 pl-3">
      <div class="flex items-center space-x-5">
        <div class="flex items-center">
          <button
            type="button"
            class="-m-2.5 flex size-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400"
            onClick={props.onAttach}
          >
            <PaperClipIcon aria-hidden="true" class="size-5" />
      ...
      <div class="shrink-0">
        ...
        >
          {props.isSubmitting ? props.submittingText || "Posting..." : props.submitText}
        </button>
      </div>
    </div>
  );
