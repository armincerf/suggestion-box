import { createForm, Form, useArrayField } from "@gapu/formix";
import { createSignal, Show } from "solid-js";
import { z } from "zod";
import { useCreatePoll } from "../../hooks/mutations/pollMutations";
import { useUser } from "../../hooks/data/useUser";
import { LoadingSpinner } from "../LoadingSpinner";
import type { CreatePollInput } from "../../hooks/mutations/pollMutations";
import {
	TextField,
	ArrayField,
	ErrorMessage,
		...
		<Form context={formContext}>
			<div class="space-y-4 bg-base-200 dark:bg-gray-700 p-4 rounded-lg shadow-md">
				...
				<Show when={props.isPollActive}>
					<p class="text-warning text-xs px-1">
						Cannot create: A poll is already active.
					</p>
				</Show>
				...
				<div class="flex justify-end space-x-2 pt-4 border-t dark:border-gray-600 mt-4">
					...
					<button
						...
						disabled={
							isSubmitting() ||
							formContext.errors().length > 0 ||
							props.isPollActive
						}
						title={
							props.isPollActive
								? "Cannot create poll while another is active"
								: ""
						}
					>
