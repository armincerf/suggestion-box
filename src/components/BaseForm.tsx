...
export function BaseForm(props: BaseFormProps) {
  ...
  return (
    <div class={`flex items-start ${props.compact ? 'space-x-2' : 'space-x-4'}`}>
      <UserAvatar 
        ...
        <form onSubmit={handleSubmit} class="relative" id={props.id}>
          <Show when={props.inReplyTo}>
            <div class="mb-2 text-sm text-gray-500 dark:text-gray-400">
              Replying to <span class="font-medium text-gray-900 dark:text-white">{props.inReplyTo}</span>
            </div>
          </Show>
          ...
          <TextField
            ...
            placeholder={props.placeholder || "Add your text... (Press Enter to submit, Shift+Enter for new line)"}
